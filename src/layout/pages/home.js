              ...
              <div className="header">
                <div className="bg">
                  <div className="contents">
                    ...
                    <p>
                      Achieve your NutrifyXperts with a customized diet plan that
          ...
          <div className="row">
            <div className="col-12">
              <div className="title_content">
                <h2>How NutrifyXpert Works</h2>
                <p>
                  Start by selecting your NutrifyXperts—whether it's weight loss,
                ...
                <div className="col-3">
                  <div className="single_card">
                    ...
                    <div className="content">
                      ...
                      <p>
                      Your diet analysis provides an overview of your nutrient intake, identifying areas of strength and areas where you may need improvement to meet NutrifyXperts.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-3">
                  <div className="single_card">
                    ...
                    <div className="content">
                      ...
                      <p>
                      Log your meals daily to stay mindful of your nutrition and reach your NutrifyXperts.
                      </p>
                    </div>
                  </div>
                </div>
